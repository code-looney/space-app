...
const Header = () => {
  ...
  return (
    <div className='w-full h-[88px] lg:h-[96px] flex justify-between lg:justify-end items-center font-barlowCondensed tracking-widest relative'>
        <div className='xl:w-full relative gap-[64px] items-center lg:absolute lg:left-0 z-40 xl:z-0 lg:h-[48px] lg:min-w-[160px] pl-[1.5em] lg:pl-[2.5em] lg:justify-start flex'>
            <Link><img className='h-[40px] w-[40px] lg:w-[48px] lg:h-[48px] cursor-pointer' src="/assets/shared/logo.svg" alt="logo" /></Link>
            <hr className='w-full translate-x-32 hidden absolute xl:block' />
        </div>
        ...
        <ul className='h-full lg:w-[640px] flex-row lg:backdrop-blur-xl lg:bg-white/5 justify-end z-10 xl:z-0 items-center pr-[3em] hidden gap-[3em] text-[1rem] lg:flex relative text-white uppercase'>
        <li className=' w-full xl:block hidden'>
        <hr className='w-full text-[#979797] hidden xl:block' />
        </li>
