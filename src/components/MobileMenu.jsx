...
const MobileMenu = () => {
    ...
    return (
        ...
        >
            <div className={`flex-col w-[254px] right-0 top-0 absolute no-scrollbar 
              ${context.toggleMobileMenu === false ? `transition transform duration-700 ease-in-out translate-x-0 opacity-100` : "" } text-white backdrop-blur-xl z-40 bg-white/5`}>
