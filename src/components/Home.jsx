        ...
        <div className='overflow-scroll no-scrollbar w-full'>
          ...
          <div className='p-[1.5em] lg:pb-[1.5em] lg:pl-[1.5em] lg:pr-[1.5em] lg:pt-[8em] lg:gap-[80px] text-white flex flex-col '>
            ...
            <div className=' h-[382px] lg:h-[272px] outline-4 w-full flex justify-center items-center relative z-30'>
                ...
                className='z-50 font-bellefair relative cursor-pointer uppercase text-[1.125rem] lg:text-[2rem] text-veryDarkNavy w-[144px] lg:w-[272px] lg:min-h-[272px] min-h-[144px] rounded-full flex justify-center items-center bg-white select-none'>Explore</button>
                {/* look for the right dimensions */}
                <div className={`w-[480px] h-[480px] flex justify-center items-center rounded-full bg-${hover} opacity-[10%] absolute ease-in-out duration-700 z-40`}></div>
            </div>
          </div>
        </div>
    </div>
